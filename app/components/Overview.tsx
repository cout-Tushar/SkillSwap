  ...
  useEffect(() => {
    const fetchSkills = async () => {
      try {
        ...
        const match_req = await fetch("/api/swap/display?email=" + email);
        const match_data = await match_req.json();
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="glass-effect rounded-3xl p-6 border-red-900/30">
              ...
              <div className="space-y-4">
                {messages.map((msg) => (
                  <div key={msg.id} className="flex items-start gap-4 pb-4 border-b border-red-900/20 hover:bg-white/5 p-3 rounded-lg transition cursor-pointer">
            ...
            <div className="glass-effect rounded-3xl p-6 border-red-900/30">
              ...
              <div className="space-y-4">
                {matches.map((match) => (
                  <div key={match.id} className="flex items-start gap-4 pb-4 border-b border-red-900/20 hover:bg-white/5 p-3 rounded-lg transition">
